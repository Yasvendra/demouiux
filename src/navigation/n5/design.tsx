...
function SubsectionSidebar({
  ...
  return (
    <aside className="hidden h-full max-h-full shrink-0 flex-col overflow-hidden border-l border-stone-200/80 bg-[#faf9f6] xl:sticky xl:top-0 xl:flex xl:w-64 2xl:w-72">
      ...
      <div className="shrink-0 border-t border-stone-200/80 px-4 py-3 text-[11px] text-stone-500">
...
export default function Design() {
  ...
  return (
    <div className="flex h-dvh w-full overflow-hidden bg-[#f3f1ec]">
      {mobileNavOpen && (
        <button
          type="button"
      ...
      <aside
        ...
        className={`fixed inset-y-0 left-0 z-50 flex h-dvh max-h-dvh shrink-0 flex-col border-r border-white/[0.06] bg-linear-to-b from-[#181d27] via-[#12161f] to-[#0c0f15] shadow-[inset_-1px_0_0_rgba(255,255,255,0.03)] transition-[transform,width] duration-300 ease-in-out lg:sticky lg:top-0 lg:translate-x-0 ${
          mobileNavOpen
            ? 'w-[min(17.5rem,88vw)] translate-x-0'
            : '-translate-x-full lg:translate-x-0'
        } ${
          collapsed ? 'lg:w-[4.75rem] lg:overflow-visible' : 'lg:w-[17.5rem] lg:overflow-hidden'
        }`}
      >
        <div
        ...
        <nav className="min-h-0 flex-1 overflow-y-auto px-2.5 py-3 [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
        ...
        <div className={`shrink-0 border-t border-white/[0.06] p-2.5 ${collapsed ? 'lg:overflow-visible' : ''}`}>
      ...
      <main className="relative z-0 flex h-dvh min-w-0 flex-1 flex-col overflow-hidden">
        <header className="sticky top-0 z-10 flex min-h-14 shrink-0 items-center justify-between gap-3 border-b border-stone-200/80 bg-[#faf9f6] px-4 py-3 shadow-[0_1px_0_rgba(255,255,255,0.8)] sm:px-6">
        ...
        <div className="flex min-h-0 flex-1 overflow-hidden xl:flex-row">
          <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden bg-[#f3f1ec] p-2 sm:p-3">
            {activeItem && (
              <SubsectionMobileBar
                title="Related views"
            ...
            <div className="relative mt-2 min-h-0 flex-1 overflow-hidden rounded-xl border border-stone-200/80 bg-white shadow-[0_8px_30px_rgba(15,23,42,0.06)] sm:mt-3 xl:mt-0">
              {activeSubsection ? (
                <iframe
